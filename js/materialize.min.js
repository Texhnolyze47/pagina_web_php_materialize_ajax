...
window.cash = (function () {
    ...
    function x(t, e) {
        var i = M(t);
        return (
            void 0 === i[e] && (i[e] = t.dataset ? t.dataset[e] : _(t).attr("data-" + e)),
            i[e]
        );
    }
    y.extend({
    ...
    function N(t, e) {
        return (
            "&" + encodeURIComponent(t) + "=" + encodeURIComponent(e).replace(/%20/g, "+")
        );
    }
    function z(t) {
        var e,
...
(M.anime = (function () {
    ...
    function C(e, i) {
        function t(t) {
            return (
                (t = void 0 === t ? 0 : t), e.el.getPointAtLength(1 <= i + t ? i + t : 0)
            );
        }
        var n = t(),
            s = t(-1),
                                ...
                                value: function () {
                                    ...
                                    (this.$modalEl = g(B._template)),
                                        ...
                                        (this.formats = {
                                            ...
                                            yy: function () {
                                                return ("" + e.date.getFullYear()).slice(
                                                    2
                                                );
                                            },
                                            yyyy: function () {
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    (this.wrapper = this.$el.parent()[0]),
                                        ...
                                        (this.contentEl =
                                            this.$el.find(".tap-target-content")[0]),
